#!/usr/bin/env python3
"""
Simple working backend for the startup analyst frontend
"""
...
try:
    ...
    logger.info("✅ Smart Report Analyzer utilities loaded")
except ImportError as e:
    SMART_ANALYZER_AVAILABLE = False
    logger.warning(f"⚠️ Smart Analyzer utilities not available: {e}")
